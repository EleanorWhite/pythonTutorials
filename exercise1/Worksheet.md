We have written a small python function to test if a string is a palindrome, but it seems to fail on some of our test cases! Two of the cases that should return True instead return False.
